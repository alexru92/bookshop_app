...
public class PostponedController {
    ...
    @Autowired
    public PostponedController(BookRepository bookRepository, BookStoreUserRegister bookStoreUserRegister) {
        this.bookRepository = bookRepository;
        this.bookStoreUserRegister = bookStoreUserRegister;
    }

    @GetMapping("/postponed")
    public String handlePostponeRequest(@CookieValue(value = "cookieContent", required = false) String cookieContent,
                                    Model model) {
