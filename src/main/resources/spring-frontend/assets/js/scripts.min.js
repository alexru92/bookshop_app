                            ...
                            case'recent':
                                getData('/books/recent', {
                                    ...
                                    offset: function (){
                                        ...
                                        if (oldOffset < 4){ //first 20 elements are shown in the beginning by offset\limit = 0\20
                                            //it means that "refresh offset" should begin from 4 and have limit 5
                                ...
                                postData('/login', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        if (result) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + 'Такого пользователя не существует, либо было введено неверное сочетание логина и пароля' + '</div>');
                                        }
                                    }
                                })
                            }
                ...
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        if ($this.data('sendstatus') === 'ARCHIVED' && $this.data('check')) {
                            Login().postData('book/changeBookStatus', {
                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            ...
                                            case'popular':
                                                ...
                                                break;
                                            case'author':
                                                sendData('/books/author/' + $this.data('refreshid'))
                                                break;
                                        }
                                    }
                                }
